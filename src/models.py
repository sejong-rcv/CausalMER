...
class MULTModel(nn.Module):
    def __init__(self, hyp_params):
        ...
        hyp_params.conf_hidden_unit_size_tva = [ self.d_l, self.d_v, self.d_a ] # Transformer hidden unit size 기록
        ...
        self.dataset = hyp_params.dataset.split('_')[0]
        ...
        hyp_params.conf_kernel_tva = [self.proj_l.kernel_size[0], self.proj_v.kernel_size[0], self.proj_a.kernel_size[0]]
    ...
    def forward(self, x_l, x_a, x_v):
        ...
        """
        x_l = F.dropout(x_l.transpose(1, 2), p=self.embed_dropout, training=self.training) # 입력 텐서의 일부 요소를 확률 P로 무작위로 영점화
        ...
        return output, last_hs # last_hs_proj # for t-sne